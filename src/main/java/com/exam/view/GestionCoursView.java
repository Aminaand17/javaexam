...
import com.exam.entities.Classe;
import com.exam.entities.Niveau;
import com.exam.entities.Professeur;
import com.exam.services.CoursService;

public class GestionCoursView {
    private final CoursService coursService;
    private final Scanner scanner;

    public GestionCoursView(CoursService coursService) {
    ...
    public void ajouterCours() {
        ...
        Cours cours = new Cours(nom, professeur, classes, module);
    ...
    public void afficherTousLesCours() {
        System.out.println("\n===== Tous les cours =====");
        List<Cours> cours = coursService.afficherCours();
        if (cours.isEmpty()) {
